...
if old not in text:
    raise SystemExit('Expected secondary Resume Retail Payment block not found')
path.write_text(text.replace(old, new, 1), encoding='utf-8')
print('Secondary linked retail resume flow now returns through mandatory HPI wizard')
